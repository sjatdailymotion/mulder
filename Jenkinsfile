pipeline {
  ...
  stages {
    stage('CI Build and push snapshot') {
      ...
      steps {
        container('go') {
          dir('/home/jenkins/go/src/github.com/sjatdailymotion/mulder') {
            checkout scm
            sh "make test-unit"
            sh "make linux"
          ...
          dir('/home/jenkins/go/src/github.com/sjatdailymotion/mulder/charts/mulder') {
            sh "jx step helm build"
          }
          dir('/home/jenkins/go/src/github.com/sjatdailymotion/mulder/charts/preview') {
            sh "make preview"
